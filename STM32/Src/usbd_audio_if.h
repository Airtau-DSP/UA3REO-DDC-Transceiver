...
#include "functions.h"
	...
	extern int16_t USB_AUDIO_rx_buffer_a[(AUDIO_RX_BUFFER_SIZE / 2)];
	extern int16_t USB_AUDIO_rx_buffer_b[(AUDIO_RX_BUFFER_SIZE / 2)];
	extern int16_t USB_AUDIO_tx_buffer[(AUDIO_TX_BUFFER_SIZE/2)];
