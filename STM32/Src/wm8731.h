...
extern uint16_t CODEC_Audio_Buffer[CODEC_AUDIO_BUFFER_SIZE] __attribute__((aligned(4)));
extern uint16_t CODEC_Audio_Buffer_TX[CODEC_AUDIO_BUFFER_SIZE] __attribute__((aligned(4)));
