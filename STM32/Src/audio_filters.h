...
#define IQ_HILBERT_TAPS 89
#define FIR_LPF_Taps 89
#define IIR_2k7_MAXnumStages 14
#define IIR_aa_5k_numStages 6

#define FIR_RX_HILBERT_STATE_SIZE (IQ_HILBERT_TAPS + FPGA_AUDIO_BUFFER_SIZE)
#define FIR_RX_LPF_STATE_SIZE (IIR_2k7_MAXnumStages+FPGA_AUDIO_BUFFER_SIZE)
#define FIR_RX_AA_STATE_SIZE (IIR_aa_5k_numStages+FPGA_AUDIO_BUFFER_SIZE)
...
extern float32_t i_rx_3k6_coeffs[IQ_HILBERT_TAPS];
extern float32_t q_rx_3k6_coeffs[IQ_HILBERT_TAPS];
extern float32_t FIR_2k7_LPF[FIR_LPF_Taps];
